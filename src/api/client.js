    ...
    init: function() {
        ...
        */
        ...
        // this.weichat = localStorage.getItem('weichat');
				...
				this.color = VueCookie.get('color');
				this.weichat = VueCookie.get('weichat');
        if (!this.userid) {
            return
        }
        ...
        //连接websocket后端服务器
        this.socket = io.connect('ws://yibu.a10store.com:3000');
        ...
        this.socket.on('message', function(obj) {
            // var isme = (obj.userid == CHAT.userid) ? true : false;
						// console.log(iView);
						console.log(obj);
						iView.Message.success(obj.username + '上传了一个文件！')
            CHAT.uploadinfo.push(obj)
        });
